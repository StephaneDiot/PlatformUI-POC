 ...
 */
YUI.add('ez-dashboardblockrhonereviewview', function (Y) {
    'use strict';

    /**
     * Provides the All Content Dashboard Block View class
     *
     * @module ez-dashboardblockrhoneereviewview
     */
    Y.namespace('eZ');

    var BLOCK_IDENTIFIER = 'Rhone-review',
        events = {
     ...
     *
     * @namespace eZ
     * @class dashboardblockrhonereviewview
     * @constructor
     * @extends eZ.DashboardBlockAsynchronousView
     */
    Y.eZ.DashboardBlockRhoneReviewView = Y.Base.create('dashboardBlockRhoneReviewView', Y.eZ.DashboardBlockAsynchronousView, [Y.eZ.DraftConflict], {
        ...
        _fireLoadDataEvent: function () {
            ...
            this.fire('locationSearch', {
                viewName: 'Loire-review-' + '3337',
                resultAttribute: 'items',
                loadContentType: true,
                search: {
                    filter: {ParentLocationIdCriterion: '3337'},
